...
public class Constants
{
    ...
    public static final String UMS_SSO_URL = "UMS_SSO_URL";
    public static final String UMS_CLIENT_ID = "UMS_CLIENT_ID";
    public static final String UMS_CLIENT_SECRET = "UMS_CLIENT_SECRET";
    ...
    public static final String FINALIZE_DOC_LIST = "/opt/ibm/wlp/usr/servers/defaultServer/logs/KVPClassValues.txt";
}
