...
public class HMACAuthentication
{
     ...
     */
    static public boolean verifyHMACHeader(String hmacHeaderValue, JSONData jsonData)
    {
        String method = "HMACAuthentication.verifyHMACHeader: ";
        boolean verified = false;
        String hmacComputed = null;
        
        String requestPayload = jsonData.hmacJsonStr;
     ...
     */
    static private String calculateHMAC(String data, String key)
